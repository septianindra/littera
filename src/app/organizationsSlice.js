...
export const countOrganization = createAsyncThunk(
  "organizations/countOrganization",
  async () => {
...
const organizationsSlice = createSlice({
  ...
  extraReducers: {
    [countOrganization.pending]: (state) => {
      state.organizationTotalStatus = "loading";
    },
    [countOrganization.fulfilled]: (state, action) => {
      state.organizationTotalStatus = "succeeded";
      state.organizationTotal = action.payload;
    },
    [countOrganization.rejected]: (state, action) => {
      state.organizationTotalStatus = "failed";
    },
